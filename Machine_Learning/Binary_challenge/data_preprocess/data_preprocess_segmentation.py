...
if __name__ == '__main__':
    ...
    train_nevus_features, train_nevus_labels = process_image_directory_sample(train_nevus_path, label=0, sample_size=train_sample_size)
    train_others_features, train_others_labels = process_image_directory_sample(train_others_path, label=1, sample_size=train_sample_size)
    val_nevus_features, val_nevus_labels = process_image_directory_sample(val_nevus_path, label=0, sample_size=val_sample_size)
    val_others_features, val_others_labels = process_image_directory_sample(val_others_path, label=1, sample_size=val_sample_size)
