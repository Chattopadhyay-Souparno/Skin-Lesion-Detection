...
def process_image(file_path, total_files):
...
def process_image_directory(directory):
    ...
    with ThreadPoolExecutor() as executor:
        futures = {executor.submit(process_image, file, total_files): file for file in file_paths}
...
test_features = process_image_directory(test_image_path)
...
np.save('X_test_no_segmentation_hair.npy', X_test)

print("Feature extraction and hair removal for test set complete. Data saved to X_test_no_segmentation_hair.npy")